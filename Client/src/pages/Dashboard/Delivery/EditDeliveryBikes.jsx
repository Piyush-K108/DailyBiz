...
import UploadDeliveryBikesModal from "./UploadDeliveryBikesModal";
import { useNavigate } from "react-router-dom";
import { Upload } from "@mui/icons-material";
const EditDeliveryBikes = () => {
  const { id } = useParams();
  const licensePlate = id.replace(/-/g, ""); 
  ...
  useEffect(() => {
    ...
    fetch(`http://${API_URL}/Delivery_Bikes/delivery-bikes/${licensePlate}/`, {
      method: "GET",
    })
...
export default EditDeliveryBikes;
