  ...
  return (
    ...
    <div className="bg-white flex flex-col  h-[100%] ">
      <div className="flex flex-col justify-center items-center">
        <div
          className="flex flex-col items-center shadow m-4 pt-10  h-[600px] sm:rounded-tr-[200px] sm:rounded-bl-[200px] rounded-bl-[100px] rounded-tr-[100px] w-[320px] sm:w-[500px] bg-cover bg-center border-2 border-yellow-400"
        ...
        >
          ...
          <form onSubmit={handleSubmit}>
            ...
            {isLoading ? (
              ...
              <button
                type="submit"
                className="bg-yellow-400 mt-4  hover:bg-yellow-400 text-black py-2 px-4 rounded focus:outline-none focus:ring focus:border-blue-300 active-bg-yellow-800"
              >
                Submit
              </button>
            )}{" "}
