...
function Revenue() {
  ...
  const fetchTData = () => {
    ...
    fetch(`http://${API_URL}/Admin/TodayR2/?date=${date}`, {
      method: "GET",
    })
  ...
  const fetch_Week_Data = () => {
    fetch(`http://${API_URL}/Admin/WeeklyR2/`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  const fetch_Month_Data = () => {
    fetch(`http://${API_URL}/Admin/MonthlyR2/`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  const fetch_Year_Data = () => {
    fetch(`http://${API_URL}/Admin/YearlyR2/`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  const fetchMultiLineData = () => {
    fetch(`http://${API_URL}/Admin/DividedHourlyR2/`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  const fetchWData = () => {
    fetch(`http://${API_URL}/Admin/WeekR2/`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  const fetchMData = () => {
    ...
    fetch(`http://${API_URL}/Admin/MonthR2/?month=${month}&year=${year}`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
  ...
  const fetchYData = () => {
    ...
    fetch(`http://${API_URL}/Admin/YearR2/?year=${year}`, {
      method: "GET",
    })
      .then((response) => response.json())
      .then((responseJson) => {
